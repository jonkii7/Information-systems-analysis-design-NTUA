...
for threads in "1","2","4","16","48","96":
  for workload in "B", "C", "E", "A":
    for ops in "10000", "100000", "300000", "1000000", "1500000":
      a = f"./drive/MyDrive/arangodb2Shards/arango2Shards_Workload{workload}/arango2Shards_wl"
      b = "_run_"
      c = "Thr_"
      d = "Ops.txt"
  ...
  df.plot(x='Operations',
        kind='bar',
        stacked=False,
        title=f'Two Shards ArangoDB, {threads} Thread: Throughput-Operations Diagram')
...
for threads in "1","2","4","16","48","96":
  ...
  df.plot(x='Operations',
        kind='bar',
        stacked=False,
        title=f'Two Shards ArangoDB, {threads} Thread: Latency-Operations Diagram')
