...
for threads in "1","2","4","16","48","96":
  for workload in "B", "C", "E", "A":
    for ops in "10000", "100000", "300000", "1000000", "1500000":
      a = f"./drive/MyDrive/mongodb3Shards/mongo3Shards_Workload{workload}/mongo3Shards_wl"
      b = "_run_"
      c = "Thr_"
      d = "Ops.txt"
  ...
  df.plot(x='Operations',
        kind='bar',
        stacked=False,
        title=f'Three Shards MongoDB, {threads} Thread: Throughput-Operations Diagram')
...
for threads in "1","2","4","16","48","96":
  ...
  df.plot(x='Operations',
        kind='bar',
        stacked=False,
        title=f'Three Shards MongoDB, {threads} Thread: Latency-Operations Diagram')
